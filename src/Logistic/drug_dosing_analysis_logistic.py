...
tab2.set_fontsize(9)
tab2.scale(1.2, 1.4)
axes[1].set_title("Logistic ABM Fragility (even vs odd)", fontsize=12, pad=10)

# ----- Save figure ----- #
output_path = Path(__file__).parent / "logistic_fragility_comparison.png"
