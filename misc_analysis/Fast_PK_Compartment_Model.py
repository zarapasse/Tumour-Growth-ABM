# This script plots the 1-Compartment PK model from Pierek with (α>0) and without (α=0) drug decay for FAST drug decay.
...
plt.savefig("misc_analysis/graphs/Fast_PK_Results.png", dpi=300, bbox_inches="tight")
print("Figure saved as 'Fast_PK_Results.png'")
